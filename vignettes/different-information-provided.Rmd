---
title: "Different Information Scenarios in disaggR"
...
The `disaggR` package provides flexible methods for data disaggregation with uncertainty propagation. This vignette demonstrates how the sampling behavior of `rdisagg()` changes based on the information you provide.
...
The `disaggR` package automatically selects appropriate distributions based on the information you provide:
